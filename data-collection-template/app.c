...
/*---------------------------------------------------------------------------*/
#define MSG_PERIOD (30 * CLOCK_SECOND) /* [Lab 7] Non-sink nodes send data packets every 30 seconds + random delay */
...
linkaddr_t sink = {{0xF7, 0x9C}}; /* Firefly (testbed): node 1 will be our sink.
                                   * If you want to try a different sink node,
                                   * check https://research.iottestbed.disi.unitn.it/idMapping/ 
                                   * to identify its short address. */
#else
